    ...
    <body>
        <main class="mb-4 mt-5">
            <div class="container">
                ...
                <form class="form-group" method="POST" action="{{url('/admin/tag/create')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="card mb-4 mt-5">
                        ...
                        <div class="card-body mt-3">
                            <div class="form-group">
                                <div class="col-4">
                                    <input  class="form-control mt-2 " type="text" name="name" id="name" required placeholder="Create tag ">
                                </div>
